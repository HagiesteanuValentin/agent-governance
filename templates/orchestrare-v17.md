...
live settings/config, data migration · (c) Vali writes risky/complex/advisor · (d) any
...
## Effort per phase
Main effort per phase: `medium` in plan mode, `low` after ExitPlanMode. Only Vali changes the
